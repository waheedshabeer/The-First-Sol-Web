...
export const Nav = () => {
    ...
    return (
        <div className="w-full flex flex-col py-4 space-y-2 page-padding">
            <div className="flex items-center justify-end md:w-full cursor-pointer">
                <div className="flex space-x-4 ">
                    <i className="fab fa-facebook-f hover:text-black hover:text-aqua-normal text-white"></i>
                    <i className="fab fa-linkedin-in hover:text-aqua-normal text-white"></i>
                </div>
            </div>
            <div className="space-y-4 items-center md:flex md:justify-between ">
                <div className="flex items-center justify-between">
                    ...
                    <div>
                        <i
                            className="fa fa-bars md:hidden text-white text-2xl"
                            onClick={() =>
                ...
                <div className={`${THEME.TEXT} Poppins-Semibold`}>
                    <ul
                        className={`${
                            ResponsiveNavbar ? 'flex' : 'hidden'
                        } md:flex flex-col items-center md:flex-row space-x-4 cursor-pointer`}>
                        <NavLink
                            to="/"
                            className={({isActive}) =>
                                isActive
                        ...
                        <div>
                            <div className="relative group">
                                ...
                                <div className="hidden flex-col group-hover:flex group-hover:duration-1000 absolute space-y-2 w-42 bg-black-dark p-2 border text-normal Poppins-Light">
                                    ...
                                    <NavLink
                                        to="/seo"
                                        className={`hover:${THEME.HEADING} whitespace-nowral w-full`}>
                                        SEO
                                    </NavLink>
