...
export const MyWork = ({WorkRef}) => {
    return (
        <div
            className="mt-20 bg-white min-h-screen space-y-4 overflow-hidden"
            ref={WorkRef}>
            <PortfolioHeading HEADING={'My Work'} />
            <div
                data-aos="fade-left"
                className="grid grid-cols-2 gap-x-2 sm:gap-x-6 gap-y-8 ">
                <OwlCarousel
                    className="owl-theme"
                    loop
                    items={1}
                    ...
                    <div className="space-y-4">
                        <img
                            ...
                            alt=""
                            className="object-cover w-full rounded-md sm:rounded-lg h-32  sm:h-44 md:h-60 lg:h-80 lg:min-h-80 max-h-80 object-center"
                        />
